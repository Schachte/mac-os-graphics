...
func CGSManagedDisplayGetCurrentSpace(_ cid: CGSConnectionID, _ displayUuid: ScreenUuid)
  -> CGSSpaceID
...
func _SLPSSetFrontProcessWithOptions(
  _ psn: inout ProcessSerialNumber, _ wid: CGWindowID, _ mode: SLPSMode.RawValue
) -> CGError
...
func setNativeCommandTabEnabled(
  _ isEnabled: Bool, _ hotkeys: [CGSSymbolicHotKey] = CGSSymbolicHotKey.allCases
) {
...
func CGSSpaceAddWindowsAndRemoveFromSpaces(
  _ cid: CGSConnectionID, _ sid: CGSSpaceID, _ wid: NSArray, _ notSure: Int)
